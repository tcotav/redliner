...
Two later steps look for it across every section's facts at once — a
script for the narrow case it can compute exactly, an agent reading the
whole fact corpus for the joins the script can't make — and both of them
can see both sides. Your judgment here would be based on less information
than either has.
